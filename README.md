...
| `PRIORITY_LABELS` | Object  | Словарь меток приоритетов (low/medium/high)     |
...
| `validateInput(title)` | Function Declaration | `title` (string) | boolean     | Валидация названия задачи (мин. 3 символа) |
